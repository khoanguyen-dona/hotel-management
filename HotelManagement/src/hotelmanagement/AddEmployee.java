...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        String str[] = {"Reception","Room service","security"};
        ...
        submit.setBounds(60,430,120,30);
        ...
        back.setBounds(230,430,120,30);
        back.addActionListener(this);
        add(back);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("images/landmark.jpg"));
        ...
        if(ae.getSource()==submit){
            ...
            try{
                ...
                String query = "insert into employee(name,age,gender,job,salary,phone,email)"
                        + " values('"+name+"','"+age+"','"+gender+"','"+job+"','"+salary+"','"+phone+"','"+email+"')";
